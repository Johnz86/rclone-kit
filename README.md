...
<!--
[![Linting](https://github.com/Johnz86/rclone-kit/actions/workflows/lint.yml/badge.svg)](https://github.com/Johnz86/rclone-kit/actions/workflows/lint.yml)
[![MacOS_Tests](https://github.com/Johnz86/rclone-kit/actions/workflows/push_macos.yml/badge.svg)](https://github.com/Johnz86/rclone-kit/actions/workflows/push_macos.yml)
[![Ubuntu_Tests](https://github.com/Johnz86/rclone-kit/actions/workflows/push_ubuntu.yml/badge.svg)](https://github.com/Johnz86/rclone-kit/actions/workflows/push_ubuntu.yml)
[![Win_Tests](https://github.com/Johnz86/rclone-kit/actions/workflows/push_win.yml/badge.svg)](https://github.com/Johnz86/rclone-kit/actions/workflows/push_win.yml)
-->
...
pypi link: https://pypi.org/project/rclone-kit/
...
from rclone_kit import Rclone, DirListing, Config
...
def rclone_verbose(val: bool | None) -> bool:
    ...
    """
    from rclone_kit.rclone_impl import rclone_verbose as _rclone_verbose
...
class Rclone:
    ...
    def upgrade_rclone() -> Path:
        ...
        """
        from rclone_kit.util import upgrade_rclone
...
environment, dependency, build, and publishing frontend. No Bash wrapper
scripts are required on any platform, including Windows.
...
Use PowerShell or Command Prompt with the `uv` commands above. Git Bash is
not required.