...
class Rclone:
    ...
    def scan_missing_folders(
        ...
        """
        return self.impl.scan_missing_folders(src=src, dst=dst, max_depth=max_depth, order=order)
    ...
    def serve_http(
        ...
        """
        return self.impl.serve_http(src=src, cache_mode="minimal", addr=addr, other_args=other_args)
